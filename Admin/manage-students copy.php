    ...
    <main class="main" id="main">
        ...
        <div class="container mt-4">
            <div class="d-flex justify-content-center">
                <button class="btn btn-secondary mx-2" id="manual-btn">Add Student</button>
                <button class="btn btn-secondary mx-2" id="import-btn">Import Students</button>
            </div>
        </div>
        ...
        <div class="container manual mt-4" id="manual">
            <div class="card shadow-lg">
                <div class="card-header text-center">
                    <h2 class="mb-0"><?= $edit_student ? 'Edit' : 'Add'; ?> Student</h2>
                </div>
                <div class="card-body">
                    ...
                    <form action="../admin/scripts/create-student.php" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-3 d-flex justify-content-center">
                            <button type="submit" class="btn btn-primary"><?= $edit_student ? 'Edit' : 'Add'; ?> Student</button>
                        </div>
                            ...
                            <?php foreach ($students as $index => $student): ?>
                                <tr data-student-id="<?php echo htmlspecialchars($student['student_id']);?>">
                                    ...
                                    <td>
                                        ...
                                        <a href="?id=<?php echo htmlspecialchars($student['student_id']); ?>" class="btn btn-warning btn-sm">Edit</a>
