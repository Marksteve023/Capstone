    ...
    <header class="header" id="header"> 
        <div class="header-container">
            <a href="" class="header-logo" id="header-logo">
                ...
                <span><?= htmlspecialchars(ucwords($admin['role'])) ?></span>
            </a>
        ...
        <div class="sidebar-container">
            ...
            <div class="sidebar-user">
                <div class="sidebar-img">
                    <img src="<?= htmlspecialchars($admin['picture']) ?>" alt="Profile Picture">
                </div>
            ...
            <div class="sidebar-content">
                ...
                <!--=======  Manage COURSE ======-->
                <div class="sidebar-list">
                    <a href="course-section.php" class="sidebar-link">
                ...
                <!--=======  Manage Teacher ======-->
                <div class="sidebar-list">
                    <a href="manage-teachers.php" class="sidebar-link">
                ...
                <div class="sidebar-list">
                    <a href="enrollment.php" class="sidebar-link">
                        ...
                        <span>Student Course Enrollment</span>
                    </a>
                </div>
